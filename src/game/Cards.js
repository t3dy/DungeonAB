...
export const EQUIPMENT_CARDS = [
  ...
  { id: 'eq-alembic', type: CARD_TYPES.EQUIPMENT, name: 'Portable Alembic', icon: '⚗️', slot: 'tool', bonus: { mind: 2 }, bestFor: CLASSES.ALCHEMIST, text: 'A laboratory folded into a satchel. Whoever carries it can answer as an alchemist answers.', capabilities: ['alchemy', 'experimentation'] },
