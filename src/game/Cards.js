...
export const CHARACTER_CARDS = [
  ...
  { id: 'char-agrippa', type: CARD_TYPES.CHARACTER, class: CLASSES.FIGHTER, discipline: DISCIPLINES.SIGIL, name: 'Cornelius Agrippa', icon: '⚔️', stats: { health: 14, attack: 4, defense: 3, mind: 2 }, trait: 'A soldier\'s occult philosophy: sigils cut into plain steel, and a bench wherever he kneels.', capabilities: ['knowledge', 'correspondence', 'alchemy', 'conjuring'] },
  ...
  { id: 'char-brahe', type: CARD_TYPES.CHARACTER, class: CLASSES.FIGHTER, discipline: DISCIPLINES.ASTROLOGY, name: 'Tycho Brahe', icon: '⚔️', stats: { health: 13, attack: 5, defense: 2, mind: 3 }, trait: 'As quick to duel over a star-chart as to draw one. The false nose has never slowed his sword arm.', capabilities: ['tinkering', 'astronomy', 'observation', 'experimentation'] },
  { id: 'char-napier', type: CARD_TYPES.CHARACTER, class: CLASSES.FIGHTER, discipline: DISCIPLINES.NUMEROLOGY, name: 'John Napier', icon: '⚔️', stats: { health: 15, attack: 3, defense: 3, mind: 3 }, trait: 'The Laird of Merchiston defends his own estate. The neighbours whisper of a black familiar; he keeps better numbers.', capabilities: ['mathematics', 'tactics', 'knowledge', 'observation'] },

  // Clerics — healing, undead turning
  { id: 'char-ficino', type: CARD_TYPES.CHARACTER, class: CLASSES.CLERIC, discipline: DISCIPLINES.HARMONY, name: 'Marsilio Ficino', icon: '✨', stats: { health: 14, attack: 2, defense: 3, mind: 6 }, trait: 'Sings the wounded steady with astral harmony; a shrine under his hand mends deeper.', capabilities: ['music', 'harmony', 'healing', 'translation'] },
  { id: 'char-dee', type: CARD_TYPES.CHARACTER, class: CLASSES.CLERIC, discipline: DISCIPLINES.CONJURATION, name: 'John Dee', icon: '✨', stats: { health: 13, attack: 2, defense: 3, mind: 7 }, trait: 'Would rather question the restless dead than destroy them — and they usually answer.', capabilities: ['conjuring', 'divination', 'astronomy', 'mathematics'] },
  { id: 'char-forman', type: CARD_TYPES.CHARACTER, class: CLASSES.CLERIC, discipline: DISCIPLINES.ASTROLOGY, name: 'Simon Forman', icon: '✨', stats: { health: 14, attack: 3, defense: 2, mind: 6 }, trait: 'Reads a wound by the stars it was struck under. His remedies run stronger for it.', capabilities: ['astronomy', 'divination', 'medicine', 'healing'] },

  // Wizards — spell power, fragile
  { id: 'char-bruno', type: CARD_TYPES.CHARACTER, class: CLASSES.WIZARD, discipline: DISCIPLINES.MEMORY, name: 'Giordano Bruno', icon: '🔮', stats: { health: 12, attack: 2, defense: 2, mind: 10 }, trait: 'His memory palace has room for one more working than anyone else\'s head.', capabilities: ['memory', 'imagination', 'correspondence', 'conjuring'] },
  { id: 'char-pico', type: CARD_TYPES.CHARACTER, class: CLASSES.WIZARD, discipline: DISCIPLINES.CORRESPONDENCE, name: 'Pico della Mirandola', icon: '🔮', stats: { health: 13, attack: 2, defense: 2, mind: 9 }, trait: 'Finds the thread joining every school of magic, and pulls it.', capabilities: ['debate', 'syncretism', 'translation', 'knowledge'] },
  { id: 'char-cavendish', type: CARD_TYPES.CHARACTER, class: CLASSES.WIZARD, discipline: DISCIPLINES.NATURAL, name: 'Margaret Cavendish', icon: '🔮', stats: { health: 12, attack: 2, defense: 3, mind: 8 }, trait: 'Trusts the microscope as much as the grimoire — a non-occult answer for half the dungeon\'s magical problems.', capabilities: ['naturalPhilosophy', 'experimentation', 'imagination', 'alchemy'] },

  // Rogues — traps, locks, scouting, treasure
  { id: 'char-digby', type: CARD_TYPES.CHARACTER, class: CLASSES.ROGUE, discipline: DISCIPLINES.ACQUISITION, name: 'Kenelm Digby', icon: '🗡️', stats: { health: 12, attack: 4, defense: 2, mind: 6 }, trait: 'Courtier, privateer, and collector: a pirate\'s eye for what is actually worth taking.', capabilities: ['diplomacy', 'fencing', 'antiquarian', 'appraisal'] },
  { id: 'char-trithemius', type: CARD_TYPES.CHARACTER, class: CLASSES.ROGUE, discipline: DISCIPLINES.CIPHER, name: 'Johannes Trithemius', icon: '🗡️', stats: { health: 11, attack: 4, defense: 3, mind: 5 }, trait: 'Buried ciphers in mechanisms long before anyone thought to look there. Alarms he passes stay silent.', capabilities: ['telepathy', 'tactics', 'mathematics', 'knowledge'] },
  { id: 'char-fludd', type: CARD_TYPES.CHARACTER, class: CLASSES.ROGUE, discipline: DISCIPLINES.ASTROLOGY, name: 'Robert Fludd', icon: '🗡️', stats: { health: 11, attack: 5, defense: 2, mind: 5 }, trait: 'Reads the stars over a room before he reads the room. Nothing in a hoard stays hidden long.', capabilities: ['music', 'medicine', 'astronomy', 'appraisal'] },

  // Alchemists — potions, weapon mods, labs
  { id: 'char-paracelsus', type: CARD_TYPES.CHARACTER, class: CLASSES.ALCHEMIST, discipline: DISCIPLINES.TRANSMUTATION, name: 'Paracelsus', icon: '⚗️', stats: { health: 13, attack: 3, defense: 2, mind: 7 }, trait: 'Brews at any bench he finds, and has burned down three academies\' worth of orthodoxy doing it.', capabilities: ['alchemy', 'medicine', 'naturalPhilosophy', 'experimentation'] },
...
export const EQUIPMENT_CARDS = [
  ...
  { id: 'eq-boots', type: CARD_TYPES.EQUIPMENT, name: 'Boots of the Quiet Step', icon: '👢', slot: 'boots', bonus: { defense: 1, mind: 1 }, bestFor: CLASSES.ROGUE, text: 'The floorboards never learn your name.', capabilities: ['observation'] },
  ...
  { id: 'eq-warded-buckler', type: CARD_TYPES.EQUIPMENT, name: 'Warded Buckler', icon: '🛡️', slot: 'armor', bonus: { defense: 2, mind: 1 }, bestFor: CLASSES.CLERIC, text: 'The prayers are etched on the inside, where they matter. Whatever the party sets off in a room, half of it does not come back on them.', capabilities: ['knowledge'] },
  { id: 'eq-quicksilver-daggers', type: CARD_TYPES.EQUIPMENT, name: 'Quicksilver Daggers', icon: '🗡️', slot: 'weapon', bonus: { attack: 3 }, bestFor: CLASSES.ROGUE, text: 'They land before the argument starts: the party takes no damage in the first round of a fight.', capabilities: ['rogue', 'fencing'] },
  { id: 'eq-athanor-charm', type: CARD_TYPES.EQUIPMENT, name: 'Athanor Charm', icon: '🔥', slot: 'tool', bonus: { mind: 2 }, bestFor: CLASSES.ALCHEMIST, text: 'A furnace in miniature, always exactly warm enough. Anything the party sets alight burns 2 harder for the rest of the fight.', capabilities: ['alchemy'] },
  ...
  },
  {
    ...
    capabilities: ['antiquarian', 'observation'],
